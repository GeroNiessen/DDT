        ...
        tree.addActionHandler(new Action.Handler() {
            ...
            public void handleAction(Action action, Object sender, Object target) {
                ...
                if (APPLICATION_CREATE_RESOURCE.equals(action)) {
                    ...
                    BeanItem<Resource> newResourceBeanItem = new BeanItem<>(new Resource());
                    ...
                    BeanItem<de.codecentric.ddt.configuration.Application> newApplicationBeanItem = new BeanItem<>(new de.codecentric.ddt.configuration.Application());
