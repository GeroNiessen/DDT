...
public class CheckRepositoryMergesComponent extends CustomComponent implements CustomApplicationComponent{
	...
	public CheckRepositoryMergesComponent(BeanItem<de.codecentric.ddt.Application> selectedApplication){
		setApplication(selectedApplication);
	}
	
	@Override
	public void setApplication(BeanItem<de.codecentric.ddt.Application> selectedApplication) {
	...
	private void initializeRepositoriesComboBox(de.codecentric.ddt.Application selectedApplication){
