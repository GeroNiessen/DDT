...
public class JiraIssueTrackerStrategy extends IssueTrackerStrategy implements Serializable {
	...
	private JiraRestClient getJiraRestClient(IssueTracker issueTrackerContext){
	...
	private ProjectRestClient getProjectRestClient(IssueTracker issueTrackerContext){
		return getJiraRestClient(issueTrackerContext).getProjectClient();
	}
	
	private IssueRestClient getIssueRestClient(IssueTracker issueTrackerContext){
		return getJiraRestClient(issueTrackerContext).getIssueClient();
	}
	
	private SearchRestClient getSearchRestClient(IssueTracker issueTrackerContext){
		return getJiraRestClient(issueTrackerContext).getSearchClient();
	}
	
	private Iterable<BasicIssue> getSearchedIssues(IssueTracker issueTrackerContext, String jqlString){
	...
	@Override
	public List<String> getAllProjects(IssueTracker issueTrackerContext) {
	...
	@Override
	public List<String> getIssuesForProject(IssueTracker issueTrackerContext, String projectName) {
	...
	@Override
	public List<String> getOpenIssuesForProject(IssueTracker issueTrackerContext, String projectName) {
	...
	@Override
	public String getIssueStatus(IssueTracker issueTrackerContext, String ticketNumber) {
		ProgressMonitor progressMonitor = new NullProgressMonitor();
	...
	public String getName(){
		return "JiraIssueTrackerStrategy";
	}
	
	/*
	public List<String> getTransitions(IssueTracker issueTrackerContext, String ticketNumber){
